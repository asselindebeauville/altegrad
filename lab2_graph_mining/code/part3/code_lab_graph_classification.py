...
clf_gk = SVC(kernel="precomputed").fit(K_train_gk, y_train)
y_pred_gk = clf_gk.predict(K_test_gk)
accuracy_gk = accuracy_score(y_test, y_pred_gk)

print(f"Accuracy for Shortest Path Kernel: {accuracy_sp}")
print(f"Accuracy for Graphlet Kernel: {accuracy_gk}")
